...
![The Fourth Age by Byron Reese](https://m.media-amazon.com/images/I/71Qkloh2LeL._AC_UF1000,1000_QL80_.jpg){:style="display:block; margin:auto;" :height="100px" width="200px"}


*Running thoughts while reading. Philosophical, optimistic, and occasionally ranting.*
*May 2025*


### Why this book?

I have zero idea why I started this book. It's very simple in the sense that I already know what the first few parts are going to cover: language, pre-agricultural humanity, the [cognitive tradeoff hypothesis](https://en.wikipedia.org/wiki/Cognitive_tradeoff_hypothesis), and more. But I had okay hopes for a perspective I hadn't encountered yet. Hard to bear, but right to hear.
...
* The author poses three philosophical questions early on, and they're a surprisingly clean framework:
  * **What is the composition of the universe?** Either it's one thing (atoms, strings, whatever) and everything emerges from combinations of that, or there are dual things: the real world form and [Plato's world of forms](https://en.wikipedia.org/wiki/Theory_of_forms).
  * **What are we?** Either just a mechanistic machine (the [Ship of Theseus](https://en.wikipedia.org/wiki/Ship_of_Theseus) paradox), or clever animals no different from the rest (just here for timepass), or humans with a god-given soul.
  * **What is your "self"?** Either just neurons firing (no speaker in the room, the room is a party driven by external stimuli), or [emergence](https://en.wikipedia.org/wiki/Emergence) (wiring the brain up produces something qualitatively new), or the self is a soul, intrinsic and internally ingrained.
...
* This is what reading [Bostrom](https://en.wikipedia.org/wiki/Nick_Bostrom) would feel like without all the hype and speculation. Just the pure facts and the author's rendition of them. Very interesting.

**23-05-2025**

* Theories of consciousness explored in the book:
  * Weak and strong emergence
  * Consciousness as a physical property
  * [Quantum consciousness](https://en.wikipedia.org/wiki/Quantum_mind) (non-linear dynamics)
  * Consciousness as a fundamental force
  * Everything is conscious ([Integrated Information Theory](https://en.wikipedia.org/wiki/Integrated_information_theory))
...
This is basically the show [*Pluto*](https://en.wikipedia.org/wiki/Pluto_(manga)), where obviously conscious robots are made to fight each other and the moral dilemmas that follow. I still love that show.

##### Will Computers Think Like Us?

Hell naw. They're going to experience the world in a totally different mindset. I got this feeling from the [AI 2027](https://ai2027.org/) page, and it isn't going away.

Us augmenting ourselves with computers and being able to think and see in new dimensions is a real, complete possibility. Which is exactly what happens in [*Blindsight*](https://en.wikipedia.org/wiki/Blindsight_(Watts_novel)) and is really good.
...
* [Moravec's Paradox](https://en.wikipedia.org/wiki/Moravec%27s_paradox): easy things for humans are hard for computers, and vice versa
* [Lump of Labour Fallacy](https://en.wikipedia.org/wiki/Lump_of_labour_fallacy): the misconception that there's a fixed amount of work in an economy. Economists consider this wrong because total work expands as the economy grows.
* Keynes' [*Economic Possibilities for our Grandchildren*](https://en.wikipedia.org/wiki/Economic_Possibilities_for_our_Grandchildren)
...
His points are good, and the ideas are mostly rebuffs of things I've already read or gleaned, but presented in such a neutrally optimistic way that it's fun. He paints a utopic-optimistic world rather than the bleak techno-dystopian consumerism proposed by [Lanier](https://en.wikipedia.org/wiki/Jaron_Lanier). And I agree with the latter. Life always takes the path of shortcuts. And drugs are an example of that.
...
The chain goes something like: loss of meaning → hedonism → drugs (mentally numbing yourself) → crime/carnage. It's [Maslow's hierarchy](https://en.wikipedia.org/wiki/Maslow%27s_hierarchy_of_needs) collapsing from the top.

##### About the Author

Pretty fun book. Felt like reading [Yuval Noah Harari](https://en.wikipedia.org/wiki/Yuval_Noah_Harari) again. Good words. A very good introduction to philosophy of the mind. He's well read, but he quotes the same people I knew in 2023 (probably because they blew up even more after 2018): Elon Musk, Sam Altman, Andrew Ng, and more.

He's into Keynesian economics, still talks about [Steven Pinker](https://en.wikipedia.org/wiki/Steven_Pinker) and all. I feel like he's going to be 30-year-old me: read up on all these people, having enough knowledge to write a book.
...
* **The Yuga Connection:** The contrast of the 1st, 2nd, and 3rd ages can be mapped onto the ancient [Yuga](https://en.wikipedia.org/wiki/Yuga) concept. The oldies framed it in terms of spiritual values; we're just basing it on technology. Pretty interesting line of thought if you ask me.
...
* [The Future of Work report 2013](https://www.gov.uk/government/publications/future-of-work)
